<template>
  <div class="navigation-bar">
    <div
      class="navigation"
      :class="{
        scrolled: $store.state.menuScrolled,
        done:
          ($store.state.menuScrolled && $store.state.menuScrolledDone) ||
          $route.path === '/about' ||
          $route.path === '/contact' ||
    ...
    >
      <nav role="navigation" class="container is-flex navbar">
        ...
        >
          <transition-group name="rotate" mode="out-in">
            <div class="rotate" key="closed" v-if="!$store.state.navOpen">
              <BurgerMenu
                :fill="
                  ($route.path === '/' && 'black') || $store.state.menuScrolled
                    ? 'black'
                    : 'white'
                "
                :stroke="
        ...
        <ul
          ...
          :class="
            ($route.path === '/' || $route.path === '/contact') && 'black'
          "
        >
          <nuxt-link
            no-prefetch
