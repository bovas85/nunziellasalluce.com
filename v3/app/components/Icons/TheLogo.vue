...
const computedViewBox = computed(() => {
  if (windowWidth.value < 577) {
    ...
    const w = typeof computedWidth.value === 'string' ? parseFloat(computedWidth.value) : computedWidth.value
    const h = typeof computedHeight.value === 'string' ? parseFloat(computedHeight.value) : computedHeight.value
